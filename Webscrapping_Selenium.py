...
scrappedReviewsAll.to_csv('scrappedReviewsAll2.csv')


df = pd.read_csv('scrappedReviewsAll2.csv')
conn = sql.connect('scrappedReviewsAll2.db')
df.to_sql('scrappedReviewsAllTable2', conn)       
